...
- [Pengenalan Bahasa C](#pengenalan-bahasa-c)
  - [Statement](#statement)
  - [Library dalam C](#library-dalam-c)
...
- [Operator](#operator)
  ...
  - [Operator Lain](#operator-lain)
    ...
    - [Operator Subscript (`[]`)](#operator-subscript-)
...
Selain IDE, cara mudah untuk membuat program C adalah dengan menggunakan compiler online pada link berikut:

- [Programriz C Online Compiler](https://www.programiz.com/c-programming/online-compiler/)
...
## Library dalam C
Dalam pemrograman, library adalah kumpulan kode yang telah ditulis sebelumnya (berisi function, class, modul) dan dapat digunakan untuk menyelesaikan tugas-tugas tertentu sesuai yang diinginkan oleh programmer. Tujuan utama dari library adalah menyediakan solusi siap pakai, sehingga programmer tidak perlu membangun segalanya dari awal. Pada contoh berikutnya kita menggunakan library `stdio.h` yang mana untuk membantu kita dalam standard input dan output dalam bahasa pemrograman C
...
**Keyword** merupakan kata-kata yang sudah ada di library bahasa yang digunakan pada bahasa pemograman. Kata-kata khusus tersebut mempunyai makna tersendiri bagi compiler, dan kata-kata tersebut merupakan bagian dari sintaks dan tidak dapat digunakan sebagai identifier.
...
|-----------------|:------------------------------------------|
| `\b`            | Backspace                                 |
| `\f`            | Form feed (semacam new page dalam word)   |
| `\n`            | Newline                                   |
| `\r`            | Return                                    |
| `\t`            | Tab horisontal                            |
| `\v`            | Tab vertikal                              |
...
Operator ternary juga dikenal sebagai **conditional operator (? :)**, merupakan operator yang digunakan **untuk mengekspresikan boolean (True or False)**. Operator ini merupakan sebuah **alternatif pengganti untuk statement if-then-else yang akan ada pada modul berikutnya**. perator ini mengambil tiga operand: 
- kondisi boolean yang dievaluasi 
- ekspresi yang dieksekusi jika kondisi tersebut benar
- ekspresi yang dieksekusi jika kondisi tersebut salah

Jadi operator ternary ini bisa dianggap sebagai trigger ketika suatu kode telah memenuhi kondisi benar atau salah saat dijalankan. Cara penulisan operator ternary adalah sebagai berikut

```
kondisi boolean yang dievaluasi ? ekspresi yang dieksekusi jika kondisi benar : ekspresi yang dieksekusi jika kondisi salah
```
...
```c
int umur = 18
umur >= 18 ? printf("Cukup Umur") : printf("Dibawah Umur");
printf("%s", umur >= 18 ? "Cukup Umur" : "Dibawah Umur");
```
